...
import { v4 } from 'uuid';
import { requestPostsByPublicID } from '../../../../pages/SingleGroupPage/model/services/requestPostsByPublicID';

export const publishPostInPublic = createAsyncThunk<
  any,
  string,
  ThunkConfig<any>
>('singleGroupPage/publishPost', async (publicID, thunkAPI) => {
